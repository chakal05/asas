												...
												<a
													className={
														link.label === 'Place ad'
															...
															: 'block p-2 text-lg font-bold text-sky-900 border-b border-gray-300 hover:bg-slate-200 md:hover:bg-transparent md:border-0 md:hover:underline md:hover:underline-offset-4 md:p-0 '
													}
												>
													{link.label}
												</a>
